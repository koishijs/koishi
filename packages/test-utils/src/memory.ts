...
export function registerMemoryDatabase (name = 'memory') {
  registerDatabase(name as 'memory', MemoryDatabase)

  injectMethods(name as 'memory', 'user', {
  ...
  injectMethods(name as 'memory', 'group', {
