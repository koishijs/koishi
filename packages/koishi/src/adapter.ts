...
import { defineProperty, Logger, Time } from '@koishijs/utils'
...
declare module '@koishijs/core' {
  ...
  namespace Adapter {
    export namespace WebSocketClient {
      ...
      export const Config: Schema<WebSocketClient.Config>
    }
...
abstract class WebSocketClient<S extends Bot.BaseConfig, T extends Adapter.WebSocketClient.Config> extends Adapter<S, T> {
  protected abstract prepare(bot: Bot<S>): Awaitable<WebSocket>
  protected abstract accept(bot: Bot<S>): void
  ...
  static Config: Schema<Adapter.WebSocketClient.Config> = Schema.object({
...
defineProperty(Adapter, 'WebSocketClient', WebSocketClient)
